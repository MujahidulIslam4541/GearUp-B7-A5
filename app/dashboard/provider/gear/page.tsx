...
export const metadata = {
  ...
  description: "Manage your equipment inventory, availability, and rental pricing.",
}
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <Button render={<Link href="/dashboard/provider/gear/new" />} size="sm" className="gap-1.5 self-start sm:self-auto">
      ...
      <DashboardSection
        ...
        description="All items currently listed under Peak Adventures."
      >
        <ProviderGearsList />
      </DashboardSection>
    </div>
